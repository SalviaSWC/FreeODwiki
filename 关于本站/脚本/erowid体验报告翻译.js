...
const chineseTitle = "在他脸上炸开了";

const chineseSubstances = ["氧化亚氮"];
...
"我还沉浸在那种歇斯底里的狂笑之中时，突然听见了一声巨大的爆炸声。当时我闭着眼睛，所以根本不知道那声爆炸是真实发生的还是幻觉，但也没多想。",
"接着我听见朋友大喊：“卧槽，你没事吧？”",
"什么？",
"清醒过来。",
"我睁开了眼睛。",
...
const chineseDosechart = ["剂量：","反复多次","吸入","氧化亚氮","（气体）"];

const chineseFootdataTopic = "氧化亚氮（40）：旅程后问题（8），翻车经历与灾难性体验（7），医院（36）";
