...
const chineseParas = ["在我对这种物质的研究里，一个反复出现的主题似乎就是：大家找到它时，都是想找一个可卡因替代品。嗯……我也不例外。", "太长不看：它很棒，而且绝对是一个可行的可卡因替代品。你会在NEP报告里反复看到“干净”这个词，而在合适剂量下，这个说法看来完全属实。", "剂量非常重要，直接决定体验好不好。我没有毫克秤，所以第一次剂量没弄准，整体体验不算好。第二次我还是目测，但只用了大约30%的量，问题就完全解决了。", "如果你用过2C-B之类的东西，比如30毫克左右，那么你的初始剂量看起来应该差不多是那个量，而不是一小条可卡因那种量。哈哈。", "[Erowid注：即使是同一种化学品的两份粉末样品，体积相同也不代表重量相同。因此，目测是一种不准确且有潜在危险的剂量估算方式，尤其是对那些很小剂量就有活性的物质。请参阅《剂量测量的重要性》一文。]", "我大约10天前的第一次尝试，前30分钟是类似可卡因/MDMA的身体药效和心境，非常舒服；不过30分钟后，它转变成一种过于“冲”、满身出汗的体验，我根本坐不住，而且感觉不太好。我会把那种感觉比作可卡因药效下降期，但“冲劲”还在那里。那天晚上很热，我也没有足够的降温措施，这肯定也有影响。我发现NEP很容易诱发血管收缩，程度刚好会让温暖的房间变得难以忍受。", "我第一次目测剂量估高了。我用了相当于一小条可卡因的量，肯定至少在50毫克这个范围。", "今天又试了一次。现在已经完全下来了，很多小时后在喝酒，没有察觉到药效下降期，没有像可卡因那样想要补量、停不下来的冲动。", "我当天夜里早些时候用过一些低质量苯丙胺，但质量真的很差，而且我已经超过一个小时没碰它了。", "T 00:00：", "鼻吸估计约25毫克。", "进鼻子时有一点刺激感，不算严重，2分钟后疼痛消失。", "T 00:05：", "感觉不错。这种药似乎起效很快，有一点更像MDMA的反应，会在前5到20分钟出现。这时候有必要来一波兴奋剂便便 :P", "T 00:25：", "在看播客，这会儿感觉相当棒。我原本有点担心又会全身冒汗、感觉糟糕，但到这时我很确定这次剂量卡准了，因为体验还在变得更好。想到自己第一次像个傻子一样用了太多，我自己都笑了。", "T 00:45：", "哇，这真的非常顺滑。我就是感觉很舒服。欣快感还不到可卡因的水平，但它完全被没有那些恶心的可卡因副作用以及体验稳定性给补回来了。我用大多数可卡因时，15到20分钟后就会开始惦记下一条；但这个完全没有这种需要。另外，它同时还有一种类似MDMA的身体感觉。", "T 01:20：", "过去45分钟基本一直很稳定。我一直在看播客，所有东西都比平时更好笑、更有意思。我喜欢在可卡因药效下看喜剧专场，而这个绝对能相提并论。", "这时它开始很轻微地回落，真的很轻微。我只是有点意识到，现在的开心程度大概只有10分钟前的90%，我就是这样察觉到它在下降的。没有恶心的瘾鬼感，也没有突然袭来的药效下降期。我完全可以在这里停下，但我的播客有4个小时长，而且我也没别的事可做，那为什么不呢。", "T 01:30：", "我补了一次量，只是稍微多一点，同样鼻吸。", "T 03:00", "没什么不同可报告，轨迹和效果完全一样。最后我决定明天还想做点工作，所以最好现在停下，而且这个决定很容易做出来。天啊，为了再搞点可卡因我以前能折腾到什么地步；这个药效下降期简直幸福到爆，如果这还能叫药效下降期的话。", "T 04:00 我还没准备睡，突然有了开始做那项工作的冲动。整个夜里我一直有点在想它，也稍微规划了一下。", "T 08:00 我已经高效地编程、阅读文档好几个小时了。不是满血状态，但完全有用。我以前在兴奋剂之后也有过一两次类似情况，但那时是我硬逼着自己，或者是借它来熬夜调整作息；这次完全是自然发生的，不是硬撑。它只是让我处在一种完全能够、甚至愿意像正常人一样运转的状态。对我和兴奋剂来说，这很不寻常。", "结论：", "这东西很棒。很高兴我又研究了它一次。它真的真的很不错，只是千万别按一小条可卡因的量来！"];
const chineseTitle = "救赎：第二次实验";
const chineseSubstances = ["N-乙基戊酮"];
const chineseDosechart = ["剂量：T+ 0:00", "  ", " ", "苯丙胺类物质", "  T+ 0:00", "1条", "鼻吸", "N-乙基戊酮", "  T+ 1:30", "1条", "鼻吸", "N-乙基戊酮"];
const chineseFootdataTopic = "N-乙基戊酮（722）：单独使用（16），回顾/总结（11），一般（1）";
const chineseBodyweight = "100 千克";
