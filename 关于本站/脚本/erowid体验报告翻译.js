...
const chineseTitle = "中世纪兴奋剂";
const chineseSubstances = ["D2PM"];
const chineseDosechart = ["T+ 0:00", "60 mg", "口服", "度洛西汀", "（每日）", "  T+ 0:00", "  多次", "口服", "酒精", " ", "  T+ 0:00", "25 mg", "口服", "D2PM", "（胶囊）", "  T+ 6:00", "20 mg", "口服", "D2PM", "（胶囊）", "  T+ 11:00", "2.0 mg", "口服", "D2PM", "（胶囊）"];
const chineseFootdataTopic = "D2PM (506) : 小团体 (2-9) (17), 药物联用 (3), 首次体验 (2)";
const chineseBodyweight = "80 kg";
