...
const chineseParas = ["这份报告记录的是我人生中最低谷的时刻之一。我希望它能被同样身处谷底的人看到,这样他们就不必再走一遍我走过的弯路。", "从六年级开始,我就断断续续地服用不同剂量的百忧解(有段时间换成了帕罗西汀),前后持续了六年半。这期间我还在吃利他林和控释利他林,不过在高中最后一年之前就停掉了。差不多也是在那个时候,我陷入了严重的抑郁,情绪最糟时甚至有过轻生的念头。", "2001年9月下旬,我去家庭医生那里做例行复查,想把仿制百忧解(氟西汀)的剂量从40毫克加到60毫克,顺便续开另一种安眠药佐匹克隆的处方。加量之前,我每天吃4粒10毫克的药。医生和我都觉得每天早上吞6粒实在太多,于是把10毫克的胶囊换成了20毫克的。", "那天晚上大约十点,我自己量了药。结果忘了规格已经换了,还是照老习惯吃了4粒,一共80毫克,比每日最大推荐剂量还多了20毫克。发觉自己搞错之后,我大声嘟囔了一句:“反正都已经这样了,干脆豁出去吧。”于是我吞下5片安眠药,配着不知道多少的酒(顶多两小杯烈酒),接着又吃了10到12粒百忧解,然后就去睡了。", "这份报告接下来的内容,一部分拼凑自我支离破碎的记忆,一部分来自事后我向朋友们打听到的第三方说法。", "那天晚上的事我一点也不记得了,睡得怎么样(如果睡着了的话)也不知道。早上八点我醒了,出于习惯,居然还能自己穿好衣服出门,赶上了八点一刻的公交车。上车后我望着窗外发呆,记忆像坏掉的录像带,记五秒、断五秒。我开始觉得恶心,但硬是忍着没吐,差不多撑完了整趟车程。就在离学校只剩三十秒路程的时候,我终于憋不住了。偏偏运气不巧,我坐的正好是两个紧急出口座位中的一个,于是我拉起红色把手,把车窗向外推开,对着行驶中的公交车侧面吐了个昏天黑地。", "我关上窗,转头往左边一看,坐在旁边的女生不知是被吓坏了还是惊呆了,车子最后那一小段路她一直站在过道里。车停稳后我下了车,还向司机道歉,说给她添了麻烦,并提出由我来清理。我不知道她有没有回答我,因为我接下来的记忆就直接跳到了学校里面。", "我发现自己独自站在洗手间里,盯着镜子,挤着并不存在的痘痘,浑身泛起一阵奇怪的战栗。我走出洗手间,瘫坐在对面的走廊地上,旁边是几个熟人,我跟他们聊起了一些不着边际的事。聊了大概一分钟,第一遍铃响了。再过五分钟,第二遍铃就会响,意味着第一节课开始。就在这时,我卷起右边的袖子,给其中一个人看了我手臂上的东西:显然是好几处自己扎出来的刺伤,还有五六枚大号安全别针穿进皮肤又从另一头穿出来。奇怪的是,几乎没怎么出血。", "跟我坐在一起的那群人自然被吓到了,把我一个人丢在走廊地板上。我晃到自己的储物柜前,想打开锁住柜门的锁,试了几次都没成功,干脆躺在柜子前面睡着了。我不知道自己躺了多久。后来,一个储物柜就在附近的朋友去开她自己的柜子时发现了我,把我的胳膊架在她肩上,搀着我跌跌撞撞地走向前台办公室。", "到了办公室,我请工作人员不要叫救护车,而是打电话给我妈妈。不知为什么,他们答应了。我在办公室的椅子上时睡时醒地熬了二十分钟,妈妈才赶到。我坐进车的后座,解释说自己得了流感,昨晚空腹吃了药,又没喝水。她把我送回家,自己回去上班了。", "上午十一点,我又回到了家里,躺在自己的床上,抱着一瓶水,肚子疼得直哭。", "经过这件事,我发誓再也不碰安眠药和百忧解,决定靠自己解决问题,不再依赖药物。这不是人人都能做到的事,但到目前为止,我做到了。直到今天,我仍然很难直视那天见过我的人的眼睛,尤其是看到我手臂上刺伤的那几个熟人。每次见到他们,他们的眼神都会变,我能看出其中夹杂着恐惧与不自在,仿佛在重温那些我几乎记不起来的画面。", "除了几道灰色的疤痕,我没有留下什么长期的后遗症,只是背上了羞耻感,以及被贴上“自残者”标签的社会污名。现在回头看,我觉得当时的我只是神志不清、失去了记忆,离死亡还差得远。也许我判断错了,但三年过去,那份精神上的创伤依旧鲜活,还没有开始愈合。", "希望这份记录能让大家看到,大剂量的百忧解是怎样把我推向自我伤害的。多年后回头再读一遍,我只剩下不寒而栗。"];
const chineseTitle = "痛苦的回忆";
const chineseSubstances = ["佐匹克隆", "氟西汀"];
const chineseDosechart = ["剂量:", "300毫克", "口服", "药品 - 氟西汀", "(胶囊)", "", "25毫克", "口服", "药品 - 佐匹克隆", "(药片/片剂)", "", "2小杯", "口服", "酒精 - 烈酒", "(液体)"];
const chineseFootdataTopic = "药品 - 佐匹克隆 (272), 药品 - 氟西汀 (80) : 各类 (28), 多日经历 (13), 宿醉/后续几天 (46), 抑郁 (15), 药物过量 (29), 一团糟与旅程灾难 (7), 恶性旅程 (6), 艰难体验 (5), 回顾/总结 (11), 药物联用 (3), 综合 (1)";
