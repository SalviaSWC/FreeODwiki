...
- 上述六个变量，不能是空的。如果原表格中没有，则输出空数组或空字符串
</prompt>
<glossary>
...
const chineseTitle = "等等，那管我本来是打算分两次打的……";

const chineseSubstances = ["海洛因", "纳洛酮（纳康）"];
...
const chineseDosechart = ["剂量：", "  ", "静脉注射", "海洛因", "（粉末/结晶）", " ", "  ", "静脉注射", "纳洛酮", "（液体）"];

const chineseFootdataTopic = "海洛因 (27), 纳洛酮 (339) : 药物联用 (3), 药物过量 (29), 健康问题 (27), 小群体（2-9人） (17)";

const chineseBodyweight = "180 磅";
