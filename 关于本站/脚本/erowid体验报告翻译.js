...
const chineseTitle = "远不止一阵快感";

const chineseSubstances = ["相思皮（抽吸 MAOI 与 DMT）"];

const chineseDosechart = ["剂量：", "3 mg", "口服", "褪黑素", " ", "  ", "抽吸", "相思皮", " ", "1支烟", "抽吸", "大麻"];

const chineseFootdataTopic = "相思皮 (816), DMT (18), MAOIs (83) : 小团体 (2-9) (17), 制备 / 配方 (30), 联用 (3), 通用 (1)";

const chineseBodyweight = "体重 70 kg";
