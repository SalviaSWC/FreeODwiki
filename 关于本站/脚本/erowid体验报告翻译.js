...
const chineseParas = [
"似乎在对这种物质的研究中，人们总是在寻找可卡因的替代品，而我也不例外。",
"TLDR：它非常出色，绝对是可行的可卡因替代品。干净是你会在NEP报告中反复看到的词，这在合适剂量下完全属实。",
"剂量非常重要，才能确保良好的体验。我没有毫克秤，第一次剂量因为这个原因整体体验不太好。第二次虽然还是目测，但只用了大约30%的量，就完全解决了问题。",
"如果你做过大约30毫克的2C-B之类的物质，你最初的剂量应该看起来像那样，而不是一小行可卡因。哈哈。",
"我大约10天前第一次尝试，结果是30分钟类似可卡因/MDMA的身体欣快和精神状态，非常舒服，但30分钟后就转变成过于强烈的“冲劲”和出汗体验，无法保持安静，整体感觉不太好。我会把这种感觉比作可卡因的崩溃期，但还带着那种冲劲。那天晚上很热，我没有足够的降温措施，这肯定加剧了问题，我发现NEP很容易引起血管收缩，刚好到让温暖的房间变得难以忍受的程度。",
"我第一次目测的剂量太高了，吸了一行相当于小行可卡因的量，肯定至少在50毫克左右。",
"今天又试了一次，现在已经完全下来了，几个小时后还喝了酒，完全没有可察觉的崩溃期，也没有像可卡因那种想不断补剂的冲动。",
"那天晚上早些时候我用了一些低质量的速安，但质量真的很差，而且已经一个多小时没碰了。",
"T 00:00：",
"鼻吸了估计约25毫克",
"鼻子里有点刺激，但不算严重，2分钟后疼痛就消失了。",
"T 00:05：",
"感觉不错，这种药起效很快，有点更接近MDMA的感觉，在前5-20分钟会出现。这时需要去上刺激后的厕所 :P",
"T: 00:25",
"正在看播客，此时感觉相当棒，我之前有点担心又会出太多汗感觉不好，但现在很高兴自己把剂量掌握好了，状态还在继续变好。笑自己第一次像傻瓜一样用得太多了。",
"T 00:45：",
"哇，这真的很顺滑，我只是感觉很舒服，欣快感虽然没有可卡因那么强烈，但完全被没有那些讨厌的可卡因副作用和稳定性弥补了（我用大多数可卡因15-20分钟后就会开始想再来一行，这里完全不需要），此外它同时还有MDMA般的身体感受。",
"T 01:20：",
"过去45分钟基本保持一致。我一直在看播客，一切都比平时更有趣更吸引人，我喜欢在可卡因作用下看喜剧专场，这完全可以媲美。",
"这时开始轻微地减弱，非常微妙，我只是意识到比10分钟前少享受了10%左右，我就知道要来了，没有那种讨厌的瘾君子感觉或突然的崩溃，我完全可以在这里停下，但我的播客有4小时长，我也没别的事做，所以为什么不呢。",
"T 01:30：",
"我又补了一点剂量，稍微多一点，同样是鼻吸。",
"T 03:00",
"没什么不同的要报告，完全一样的轨迹和效果，最后我决定明天还要工作，最好现在停下，这是个轻松的决定。天哪，我以前为了多搞点可卡因费了多少劲，这次的下降期简直是幸福的，如果你还能称之为下降期的话。",
"T 04:00 我还没准备好睡觉，突然有了开始做那项工作的冲动，我整晚都在想着和稍微规划它。",
"T 08:00 我已经高效地编程和阅读文档好几个小时了。虽然不是满状态，但完全能用，我以前有一两次在刺激物之后做过类似的事，但那都是在强迫自己，或者用来熬夜调整睡眠周期，这次完全是自然的，没有强迫，它只是让我处于一种完全能够而且愿意像正常人一样运作的状态，这对我和刺激物来说很不寻常。",
"总结：",
"这东西真棒。很高兴我又研究了一次。它真的真的很好，只是别吸一小行可卡因的量！"
];
const chineseTitle = "救赎：第二次实验";
const chineseSubstances = ["NEP"];
const chineseDosechart = ["剂量：T+ 0:00", "  ", " ", "苯丙胺类", "  T+ 0:00", "1行", "鼻吸", "NEP", "  T+ 1:30", "1行", "鼻吸", "NEP"];
const chineseFootdataTopic = "NEP (722)：单独使用 (16)，回顾/总结 (11)，一般 (1)";
const chineseBodyweight = "体重 100 kg";
