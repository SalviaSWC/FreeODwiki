...
const chineseParas = ["读到LSD和右美沙芬之间那种强烈的协同作用后，我就知道自己一定要试试牵牛花种子配止咳糖浆。最近一个无聊的周五晚上，我把6克未经处理的种子磨成粉，又倒出了3盎司糖浆。", "晚上10点，我把种子粉倒进一瓶水里，摇匀后直接灌了下去。然后我又加了些水，把剩下的也喝掉，尽量把种子粉都弄进肚子里。一个半小时后，我出现了轻微的闭眼视觉，像扎染T恤那种图案，粉色和绿色特别明显。到了这个时候（晚上11点半），我喝下了那3盎司糖浆，并把一张果阿迷幻电子乐CD放进了音响。", "从这以后我就没再记录时间了。听CD的感觉棒极了，受药物影响，音高出现了轻微的扭曲。一个画面浮现在我脑中：夜晚的一片开阔田野，草地上覆盖着霜。不知道为什么，我感觉草象征着右美沙芬，而霜就是牵牛花种子。我感觉此刻体验里的主角是右美沙芬，而种子里的LSA则像是在放大右美沙芬的作用。", "那张果阿迷幻电子乐专辑结束后，我吃了半毫克氯硝西泮，一种苯二氮卓类药物。我听了一会儿莫扎特的CD，美到几乎要哭出来。感觉自己像是在同时听至少3条独立音轨，每条音轨都是不同的乐器部分，而且我可以随意把每条音轨淡入淡出。通过这种方式，我能分辨出音乐结构里的每一个细节。过了一会儿，音乐变得太强烈，有点承受不住，于是我关掉音乐，打开了灯。", "频闪感非常强烈，几乎强到让我以为这可能是高剂量右美沙芬带来的“分帧”效应，但因为我在闪烁之间仍然能看见东西，所以我觉得应该不是。声音出现了镶边般的扭曲，移动会产生“拖尾”，物体的比例看起来也不对。我下楼去上厕所，惊讶地发现右美沙芬作用这么强的时候自己居然还能尿出来。解决完之后，我变得非常头晕，开始眼冒金星。我意识到自己全身通红，非常热，而且浑身都是汗。我慌了，脑子里冒出“血清素综合征”几个字，但我还清醒到足以让自己冷静下来，并给自己倒了一杯水。", "我坐在厨房地板上吃香蕉时，开始变得非常偏执。我听见一些嗡嗡声，听起来像远处的人声；每一次木头的吱呀声，在我听来都像脚步声。木地板上的纹路开始倾斜、渗流，看起来几乎像泥浆在流动。我盯着这些纹路看，开始变得非常解离，然后我竟然在睁眼状态下看到了一个右美沙芬视觉！我看见自己所有的神经元都是一个立方体结构里的光点。最上层是我大脑中常用的、有意识的部分，而下面的区域则是潜意识。接着，我感知到有一个不属于我的意识存在。", "它向我展示，万事万物都以某种方式彼此相连，每个人迟早都会连接到集体无意识，无论是通过药物、宗教，还是社会。然后它告诉我，我不该再用药了，因为这会伤害我的身体和心智。既然我已经看到了所有事件之间的互联性，就不再需要使用致幻剂了。它还说，等我有了孩子，我应该告诉他们药物是不好的。我对此感到困惑。我问：“为什么我要那样做？药物明明也可以被积极地使用。”它问我第一次用的药物是什么，我说是酒精。然后我意识到，我小时候第一次喝酒，正是因为别人告诉我不该喝，于是我笑了出来。接着我想到自己当时有多妄想，这一切其实都只是在我脑子里。那个实体笑了，说：“这正是重点。”集体意识最后告诉我，如果我成年后有一天失去了人生的意义感，就应该吃几克蘑菇。它承诺说，如果我那么做，它会回来教我更多东西。", "我猛地回过神来，发现自己仍然盯着地板。我一边退药效一边看电视，注意到人声也有一些奇怪的效果。之前听音乐时那种“多音轨”效果也发生在说话声上。一条音轨是正常的人声，第二条只有生硬的咔嗒声（比如“carrot”里的“t”或“car”里的“c”那种音），第三条则是一种摇晃、扭曲的音调，似乎就是那个人声音的音高！随着时间推移，我开始感觉非常像抽大麻后那样迟钝又犯傻，一切看起来都像是透过鱼眼镜头看到的。我大约在早上7点或8点上楼睡觉（药效仍然没完全过去），一直睡到下午3点。这是一场漫长又消耗人的旅程。"];

const chineseTitle = "那是上帝在我厨房里吗？";

const chineseSubstances = ["牵牛花种子", "右美沙芬", "氯硝西泮"];

const chineseDosechart = ["剂量：T+ 0:00", "6克", "口服", "牵牛花", "（研磨/碾碎）", "T+ 1:30", "3盎司", "口服", "右美沙芬", "（液体）", "T+ 0:00", "0.5毫克", "口服", "药物 - 氯硝西泮", "（药片/片剂）"];

const chineseFootdataTopic = "药物 - 氯硝西泮（125），右美沙芬（22），牵牛花（38）：独自使用（16），音乐讨论（22），神秘体验（9），美好体验（4），困难体验（5），药物联用（3），综合（1）";

const chineseBodyweight = "135磅";
