...
const chineseTitle = "从愚蠢中学习";
const chineseSubstances = ["依替唑仑", "酒精（乙醇）"];
const chineseParas = [
...
const chineseDosechart = ["剂量：", "  多次", "口服", "依替唑仑", " ", " ", "  多次", "口服", "酒精", "（液体）", " ", "  ", "抽吸", "大麻", "（植物材料）"];
const chineseFootdataTopic = "依替唑仑 (568), 酒精 (61)：联用 (3), 困难体验 (5), 各种 (28)";
const chineseBodyweight = "体重 180 磅";
