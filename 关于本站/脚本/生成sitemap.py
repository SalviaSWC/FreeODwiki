...
if __name__ == "__main__":
    ...
    tk.Label(
        root, text="Sitemap 生成工具（适合 Markdown/HTML wiki 项目）", font=("Segoe UI", 14, "bold")
    ).pack(pady=15)
    ...
    tk.Label(root, text="网站基础 URL（默认 https://freeod.wiki，可修改）：").pack(
