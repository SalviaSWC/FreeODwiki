[上一个](/文档/TiHKAL/tihkal09.md) [返回](/文档/TiHKAL/home.md) [下一个](/文档/TiHKAL/tihkal11.md)

# 10.[EIPT](/药物/EIPT.md)
**N-乙基-N-异丙基色胺；吲哚，3-[2-(乙基异丙基氨基)乙基]；N-乙基-N-异丙基色胺；3-[2-(乙基异丙基氨基)乙基]吲哚**

| ![](/文档/TiHKAL/tihkal10.gif) |
| --- |

**合成**：（从吲哚开始）：在一个搅拌良好的1.6克吲哚溶于30毫升无水乙醚的溶液中，在30分钟内滴加3.8克（2.6毫升）乙二酰氯溶于30毫升无水乙醚的溶液。继续搅拌15分钟，期间吲哚-3-基乙二酰氯以结晶固体形式分离。通过过滤除去该中间体并用乙醚洗涤。它直接用于下一步。将该固体酰氯加入到3.6克无水乙基异丙胺的乙醚溶液中，随后加入过量的2N盐酸。冷却混合物，通过过滤除去生成的产物N-乙基-N-异丙基吲哚-3-基乙二酰胺。风干后的产物重2.2克（产率62%），熔点为149-151 °C。

将2.0克N-乙基-N-异丙基吲哚-3-基乙二酰胺溶于50毫升无水四氢呋喃的溶液滴加到1.5克氢化铝锂溶于50毫升无水四氢呋喃的溶液中，该溶液在惰性气氛下良好搅拌。将其加热至回流并保持3小时。冷却反应混合物，通过谨慎加入湿四氢呋喃破坏过量的氢化物。然后加入15%氢氧化钠溶液，直到固体呈现疏松的白色干酪状，并且流动相经外部湿润的pH试纸测试呈碱性。通过过滤除去形成的固体，先用四氢呋喃洗涤，然后用甲醇洗涤。合并滤液和洗涤液，用无水硫酸镁干燥，并在真空下除去溶剂。残余物固化为晶体质量，重1.6克（90%）。将其从戊烷中重结晶，得到N-乙基-N-异丙基色胺（EIPT）游离碱，熔点为71-73°C。吲哚也可以作为NET的前体，NET很容易转化为EIPT。

（从N-乙基色胺，NET开始）：向0.33克N-乙基色胺碱（见NET配方）溶于4毫升异丙醇的溶液中加入1.5克碘代异丙烷和1.2克二异丙基乙胺，将其回流36小时。真空除去挥发物，向残留的黑色油状物中加入100毫升15%氢氧化钠水溶液。用3x50毫升二氯甲烷萃取，合并萃取液，除去溶剂，残余物在KugelRohr蒸馏器中蒸馏，得到0.24克（59%）N-乙基-N-异丙基色胺，为淡琥珀色油状物，沸点在0.11 mm/Hg下为150-160 °C，未结晶。质谱（m/z）：C6H14N+ 100 (100%)；C3H8N+ 58 (58%)；吲哚甲基+ 130 (11%)；母离子 230 (1%)。如上所述，该碱被转化为盐酸盐。

**给药剂量**：24 - 40 毫克，口服

**药效时长**：4 - 6 小时

**定性评论**：（24毫克，口服）“有些奇怪的事情发生了，我感到非常恶心，但同时又觉得性欲冲动。一边做爱一边呕吐会是什么感觉？有些东西不太对劲。绝对不行。然后突然间我回到了基线，什么都没留下。”

（40毫克，口服）“我看到这与口服DET和MIPT有一些相似之处，不太愉快，带有一些令人不快的成分，视觉效果更多是在背景中。Michael Valentine Smith曾描述‘小象’是可以在5-MeO-DMT中发现的东西。而这种药物中也有一点这种感觉。”

（40毫克，口服）“半小时内，我感到身体发麻，胃部非常不适。一方面这奇怪地不具有色情色彩，但我的性功能完全正常。非凡的高潮。但仍然没有色情感。没有视觉效果，没有声音增强，没有幻想，那为什么它能达到+2呢？我不知道，到第五个小时我基本上回到了基线。”

（40毫克，口服）“一小时内，出现了非常轻微的预感性恶心，大约45分钟后消失。完全没有视觉效果。那晚的梦不如之前30毫克试验时那种极好的、清晰的、漂亮的梦那么令人满意。整晚都是断断续续的睡眠，因为我大约每小时都要起来尿尿。观察：这种物质有一定的利尿成分。勉强达到+1。不会再尝试了。”

**延伸和评论**：显然这并不是一种令人兴奋的化合物。那么为什么要大费周章地制造并测试它呢？唯一的理由是二异丙基类似物完全怪异，它是那两种需要探索的怪异色胺之一。如果一切都如预测的那样，那就永远不会有发现。必须始终寻找那些要求你改变工作假设并对意外和无法解释的事物做出反应的异常现象。5-MeO-DET具有意想不到的特性，在非常小的剂量下会产生头晕和眩晕。这可能会证明它在研究中的价值，这在它自己的条目中有所讨论。这里是对另一个意外观察的反应。N,N-二异丙基色胺会导致非凡的听觉扭曲。这个分子的哪一部分导致了这种现象？是两个异丙基都需要吗？还是只需要一个？或者两个都不需要，只需要在氮原子上连接同样庞大的东西？这种化合物EIPT，是这堵墙上一块必不可少的砖，它将包含、定义并描述这种非凡的中枢神经系统特性的细节。

这就是为什么EIPT很有趣。让我列举一下二异丙基胺类似物的这些近亲，保留一个异丙基，但让另一个变成不同的东西。从这些探索中能看到什么？

| N1 | N2 | 名称 | 作用 |
| --- | --- | --- | --- |
| 甲基 | 异丙基 | MIPT | 在25毫克范围内似乎具有致幻作用，但尚未尝试40毫克的剂量。 |
| 乙基 | 异丙基 | EIPT | 令人不适的恶心和不愉快的旅程，但没有听觉干扰。 |
| 丙基 | 异丙基 | PIPT | （尚未评估） |
| 异丙基 | 异丙基 | DIPT | 在40毫克水平上产生强烈的听觉扭曲。 |
| 丁基 | 异丙基 | BIPT | （尚未评估） |

如果事实证明二异丙基取代是这种感官现象绝对必不可少的结构组成部分，那么它就成为了研究人类大脑听觉关联区最非凡的工具之一。

这就是为什么所有这些研究都很重要。你永远无法预料一种新化合物会产生什么作用。所以你必须继续制造新化合物，必须继续做观察者。这确实是一个令人兴奋的世界。

---

[上一个](/文档/TiHKAL/tihkal09.md) [返回](/文档/TiHKAL/home.md) [下一个](/文档/TiHKAL/tihkal11.md)

[上一个](/文档/TiHKAL/tihkal10.md) [返回](/文档/TiHKAL/home.md) [下一个](/文档/TiHKAL/tihkal12.md)
