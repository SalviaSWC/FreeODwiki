...
[上一个](/文档/PiHKAL/pihkal081.md) [返回](/文档/PiHKAL/home.md) [下一个](/文档/PiHKAL/pihkal083.md)
...
**延伸和评论：** 在 2-碳化合物 ([2C-G-3](/文档/PiHKAL/pihkal028.md)) 和 3-碳化合物 (G-3) 的比较中，苯乙胺（2-碳化合物）胜出。对于该系列的第一个成员（[2C-G](/文档/PiHKAL/pihkal027.md) 对比 GANESHA），这在定量效应（效力）和定性效应（活性性质）方面都是平局。在这里，随着位于决定性 3,4-位的基团体积稍大，这是有史以来第一次倾向于较短的链。效力差异很小，也许安非他命仍然稍微强一点。但这种化合物似乎有一些不适感，而苯乙胺似乎没有。取代度更高的化合物（见下文）更清楚地定义了这些差异。
