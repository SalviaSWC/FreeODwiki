...
社论够多了。回到历史技术细节。实际上，METHYL-MA 是一种经过充分研究的药物，至少在动物身上是这样。在小鼠和大鼠中，它是产生紧张症状态的异常有效的药物。由 METHYL-MA 的秘密合成引发的动物研究表明，确实存在运动刺激和一些中枢效应，但这些效应不知何故与简单的安非他命类药物不同。实验者的结论是，基于其结构与 [4-MA](/药物/4-MA.md) 的相似性及其在某些动物物种中产生紧张症的倾向，以及使用它可能会出现意想不到的神经化学变化的可能性，不鼓励进行人体实验。我也得出了同样的结论，但在我的案例中，这是基于一个更简洁的观察：我试过了，我不喜欢它。
