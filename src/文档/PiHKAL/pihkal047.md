# 47.[2C-T-15](/FreeODwiki/药物/2C-T-15.html)

[上一个](/FreeODwiki/文档/PiHKAL/pihkal046.html) [返回](/FreeODwiki/文档/PiHKAL/home.html) [下一个](/FreeODwiki/文档/PiHKAL/pihkal048.html)

**SESQUI; 2,5-二甲氧基-4-环丙基硫代苯乙胺**

| ![](/FreeODwiki/文档/PiHKAL/pihkal47.gif) |
| --- |

**合成：** 将 3.3 g 氢氧化钾（KOH）颗粒溶解于 150 mL 热甲醇（MeOH）中，加入 10 g 2,5-二甲氧基苯硫酚（其制备方法见 [2C-T-2](/FreeODwiki/文档/PiHKAL/pihkal040.html)），随后加入 10 g 1-溴-3-氯丙烷。反应放热，并立即沉淀出白色的氯化钾（KCl）固体。将反应混合物在蒸汽浴上加热几分钟，然后倒入水中淬灭。碱性反应混合物用 3x75 mL 二氯甲烷（CH2Cl2）萃取。合并萃取液并在真空下脱除溶剂。残留的油状物在 0.2 mm/Hg 下于 145-155 °C 蒸馏，得到 16.5 g 的 2,5-二甲氧基苯基-3-氯丙基硫醚，为清澈无色油状物。
...
**延伸和评论：** 在合成过程中，2C-T-15 的常用名称是 SESQUI。15 碳萜烯的通用名称是倍半萜（sesquiterpene），源自拉丁语前缀“一又二分之一”。2C-T-15 的活性水平尚不清楚。目前尝试的最高水平是口服 30 毫克，并且从 6 毫克开始就经常有阈值报告。但还没有确定的活性。该化合物与类似化合物 [2C-T-4](/FreeODwiki/文档/PiHKAL/pihkal041.html) 中的异丙基是等排的（三个碳的位置完全相同，只是电子位置不同），令人惊讶的是其效力似乎要低得多。后一种化合物仅 20 多毫克就具有压倒性的致幻作用。
