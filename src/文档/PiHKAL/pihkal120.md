[上一个](/FreeODwiki/文档/PiHKAL/pihkal119.html) [返回](/FreeODwiki/文档/PiHKAL/home.html) [下一个](/FreeODwiki/文档/PiHKAL/pihkal121.html)
# 120. [MEDA](/FreeODwiki/药物/MEDA.html)
...
**延伸和评论：** 有时候，上帝会以意想不到的美妙方式微笑。在发现了 MMDA 的活性后，"科学"的做法是将它与当时已知的另一种"拟精神病"安非他命（即 1962 年时的 TMA）进行比较。比较它们的结构，唯一的区别是 TMA 的两个相邻甲氧基被一个 5 元环（称为亚甲二氧基环）所取代。
...
在 [MDA](/FreeODwiki/药物/MDA.html) 条目下有一些关于沿此路线（使用不同方法）成功化学合成的评论，即当不存在甲氧基时。这些化合物是 EDA 和 IDA。但药理学仍然不那么令人兴奋。
