# [BOD](/FreeODwiki/药物/BOD.html)

[上一个](/FreeODwiki/文档/PiHKAL/pihkal013.html) [返回](/FreeODwiki/文档/PiHKAL/home.html) [下一个](/FreeODwiki/文档/PiHKAL/pihkal015.html)
...
（摄入25 mg）这相当快。体验的起效在半小时内就很明显，我们都在一小时内达到了[+++](/FreeODwiki/文档/PiHKAL/shulgin_rating_scale.html)。身体负荷极小。与某些物质相比，视觉效果很少。闭眼视觉非常有趣，但不是持续的——只是偶尔会有强烈的幻象闪现。非常良性、友好、愉快和幽默的感觉。极适合交谈和概念化。
...
**延伸和评论：** 这种化合物BOD是一个新苯乙胺家族的第一个探索性成员。这个家族被称为BOX系列，因为在几个具有公认芳香环取代模式且经过充分研究的药物的苄基碳原子（即“苄氧基”或“BO”）上放置了一个氧原子。“X”在这里如果是BOD就是“D”，指的是[2C-D](/FreeODwiki/文档/PiHKAL/pihkal023.html)；如果是BOB就是“B”，指的是[2C-B](/FreeODwiki/文档/PiHKAL/pihkal020.html)，依此类推。实际上最初的想法是将“O”变成代表甲氧基的“OM”，因为这将允许在命名乙氧基（“OE”）或羟基（“OH”）等事物时具有更多的通用性，但甲氧基化的[2C-B](/FreeODwiki/文档/PiHKAL/pihkal020.html)类似物会变成BOMB（炸弹），所以这个想法被放弃了。
