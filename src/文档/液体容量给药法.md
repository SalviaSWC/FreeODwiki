...
description: 
published: true
date: 2026-01-30T08:47:34.041Z
tags: 
editor: markdown
dateCreated: 2026-01-30T05:45:52.154Z
---
...
| ![Dialog-warning.png](/FreeODwiki/文件/Dialog-warning.png) | **[免责声明](/FreeODwiki/关于本站/观前提醒.html)：**<br>*本指南仅供参考和教育之用。我们不鼓励你触犯法律，也不能对你的行为承担任何责任。* |
| --- | --- |

**液体容量给药法**（Volumetric dosing）是将化合物溶解在液体中以便于测量的过程。出于[伤害减少措施](/FreeODwiki/文档/负责任的用药.html)的考虑，对于某些药效过强而无法使用传统称重天平测量的化合物，使用液体容量给药法至关重要。这种技术使得使用廉价的 30 美元天平仍能精确测量到几毫克的精度。[\[1\]](#cite_note-1)

许多精神活性物质，包括[苯二氮卓类物质](/FreeODwiki/文档/药物分类/苯二氮卓类物质.html)和某些[迷幻剂](/FreeODwiki/文档/药物分类/迷幻剂.html)，其活性剂量不到 1 毫克。如此微小的量无法用普通的数字天平准确测量，因此必须通过称量较大数量的化合物并将其溶解在计算好体积的合适液体中，来进行液体容量给药。
...
![OralSyringe2.jpg](/FreeODwiki/文件/OralSyringe2.jpg)
...
首先用[毫克称](/FreeODwiki/文档/毫克称.html)称量你想用于液体容量给药的粉末量是至关重要的。即使袋子上标明了重量，也不要假设供应商给你的物质数量是确定的；供应商给的产品多于标示量并不罕见。如果一个人认为自己收到了 500mg，但实际上收到了 1000mg，那么溶液的强度将是预期的两倍。
...
* [负责任的用药](/FreeODwiki/文档/负责任的用药.html)
* [药物剂量量取](/FreeODwiki/文档/药物剂量量取.html)
...
**[负责任的用药索引](/FreeODwiki/文档/负责任的用药.html)**
