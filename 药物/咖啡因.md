...
- | **化学信息** | 咖啡因（Caffeine）                                                                |
  | ------------ | --------------------------------------------------------------------------------- |
  | 键线式       | ![](../文件/Caffeine.svg){loading=lazy style="background-color: white" width=400} |
...
咖啡因是腺苷 A<sub>2A</sub> 受体的拮抗剂，敲除小鼠的研究特别指出 A<sub>2A</sub> 受体的拮抗作用是咖啡因产生促醒作用的原因。腹外侧视前区（VLPO）中 A<sub>2A</sub> 受体的拮抗作用减少了对结节乳头体核的抑制性 GABA 神经传递，这是一个组胺能投射核，其激活依赖性地促进觉醒。这种对结节乳头体核的去抑制是咖啡因产生促醒作用的下游机制。咖啡因是所有四种腺苷受体亚型（A<sub>1</sub>、A<sub>2A</sub>、A<sub>2B</sub> 和 A<sub>3</sub>）的拮抗剂，尽管效力各不相同。咖啡因对人类腺苷受体的亲和力（K<sub>D</sub>）值分别为：A<sub>1</sub>：12 μM，A<sub>2A</sub>：2.4 μM，A<sub>2B</sub>：13 μM，A<sub>3</sub>：80 μM。[^16]

!!! quote inline end ""

    ![](../文件/710px-Caffeine_metabolites.png){loading=lazy}
    /// caption
    咖啡因代谢物
    ///
...
!!! quote inline end ""
    ...
    ![NoDoz caffeine tablets on black.jpg](../文件/NoDoz_caffeine_tablets_on_black.jpg)
    /// caption
...
极端过量可能导致死亡。[^24] [^25] 大鼠口服的 [LD<sub>50</sub>](https://en.wikipedia.org/wiki/Median_lethal_dose)（[半数致死剂量](https://zh.wikipedia.org/wiki/%E5%8D%8A%E6%95%B8%E8%87%B4%E6%AD%BB%E9%87%8F)）为 192 mg/kg。人类咖啡因的 LD<sub>50</sub> 取决于个人敏感度，但估计约为 150 \~ 200 mg/kg，或普通成年人大约 80 至 100 杯咖啡。[^26] 虽然通过普通咖啡达到咖啡因的致死剂量很困难，但通过咖啡因药丸或干粉摄入更容易达到高剂量，而且在代谢咖啡因能力受损的个体中，致死剂量可能更低。

!!! quote inline end ""

    ![Main symptoms of caffeine overdose.png](../文件/Main_symptoms_of_caffeine_overdose.png)
    /// caption
    咖啡因过量的主要症状
    ///
...
[咖啡因诱发的焦虑障碍](https://en.wikipedia.org/wiki/Caffeine-induced_anxiety_disorder)是一种由过量摄入咖啡因引发或加剧焦虑症状的状况。高摄入量（大于 400 mg）可能导致恐慌发作，特别是在易感人群中，并可能使现有的焦虑症恶化。[^27]
