...
佐匹克隆的代谢产物去甲基佐匹克隆也具有药理活性，尽管它主要具有抗焦虑特性。一项研究发现佐匹克隆对 GABA<sub>A</sub> 受体 α<sub>1</sub> 和 α<sub>5</sub> 亚基有一些轻微的选择性，[^6] 尽管通常认为它在结合 α<sub>1</sub>、α<sub>2</sub>、α<sub>3</sub> 和 α<sub>5</sub> GABA<sub>A</sub> 苯二氮䓬受体复合物时是非选择性的。
