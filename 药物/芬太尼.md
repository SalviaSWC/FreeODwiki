...
> **[免责声明](../文档/观前提醒.md)：** FreeODwiki 的[剂量](../文档/给药剂量.md)信息收集自用户和[网络资源](../文档/关于本站/home.md)，仅用于教育目的。它不是推荐，应通过其他来源核实准确性。
...
***免责声明：** 下列效应引用自 [***主观效应索引***](../药效/home.md) (**SEI**)，这是一个基于轶事用户报告和 [PsychonautWiki](../文档/关于本站/home.md) 贡献者个人分析的开放研究文献。因此，应以健康的怀疑态度看待这些内容。*
