...
| ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| 结构式       | ![](../文件/Methamphetamine.svg){loading=lazy style="background-color: white" width=400}                                                           |
...
!!! quote inline end ""
    ...
    ![](../文件/Crystal_Meth.jpg){loading=lazy}
    /// caption
...
![](../文件/HarmCausedByDrugsTable_zh-cn.svg){loading=lazy style="background-color: white" width=600}
/// caption
