...
- | **化学信息** | 尼古丁（Nicotine）                                                                |
  | ------------ | --------------------------------------------------------------------------------- |
  | 键线式       | ![](../文件/Nicotine.svg){loading=lazy style="background-color: white" width=400} |
...
!!! quote " "
    ...
    用于皮图里的干叶 Nicotiana spp. 分析显示，尼古丁含量可高达 11 mg/g。[^12]

相比之下，尼古丁袋或浸渍烟草的尼古丁含量通常直接标在包装上，以 mg/g 为单位，通常在 4 到 14 mg/g 之间。
...
- ### **认知效应** ![User.png](../文件/User.png)
    ***
    ...
    - **[音乐欣赏能力增强](../药效/音乐欣赏能力增强.md)**：这种效应在与[致幻剂](../文档/药物分类/致幻剂.md)或其他[兴奋剂](../文档/药物分类/兴奋剂.md)物质联合使用时最明显。
    - **[记忆增强](../药效/记忆增强.md)**
    - **[动机增强](../药效/动机增强.md)**
    - **[思维加速](../药效/思维加速.md)**
    - **[清醒](../药效/清醒.md)**
...
![](../文件/Electronic_Cigarette_and_USB_Charger_%2814939561277%29_%28retouched%29.jpg){loading=lazy width=400}
/// caption
第一代电子烟，形似传统香烟
///

![](<../文件/Size_of_nicotine_pouch_(cropped).png>){loading=lazy width=220}
/// caption
单个 3 cm 尼古丁袋
///
...
!!! quote inline ""
    ...
    ![](../文件/960px-Nicotine_pastille.jpg){loading=lazy}
    /// caption
    尼古丁含片
    ///
...
!!! quote inline end ""
    ...
    ![](../文件/HarmCausedByDrugsTable_zh-cn.svg){loading=lazy style="background-color: white"}
    /// caption
...
尼古丁属高毒类物质，经口大鼠尼古丁 [LD<sub>50</sub>](https://en.wikipedia.org/wiki/Median_lethal_dose)（[半数致死剂量](https://zh.wikipedia.org/wiki/%E5%8D%8A%E6%95%B8%E8%87%B4%E6%AD%BB%E9%87%8F)）为 50 mg/kg，小鼠尼古丁 LD<sub>50</sub> 为 3.3 mg/kg，而在人类的估计口服 LD<sub>50</sub> 为 6.5 \~ 13 mg/kg，这远低于许多其他常见兴奋剂，因此通过吸烟烟草不太可能达到过量。不过，与贴片或口香糖等其他尼古丁来源联合给药可能有危险。
