...
---
    ...
    FreeODwiki是开源免费且持续更新的参考od知识整合站点。为方便理解，取舍了大量内容，具有充分了解者可离开本站或参与本站的编辑


**特别说明**：
"FreeODwiki"中的"Free"的含义**是**"我们站点对于**知识的公开**和**编写知识的权利**持有自由开放的态度"——这是一种开源项目的常见命名法 ~~(尤其当"Free"后面的内容并没有前述的性质时)~~ ，**不是**叫大家自由随性地去OD
{.is-info}
